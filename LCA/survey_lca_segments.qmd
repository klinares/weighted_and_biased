  ...
  pdf:
    ...
    include-in-header:
      text: |
        ...
        % the top of page 1, once. (scrartcl page-breaks if material precedes
        % \maketitle, hence this native hook.)
...
Design-based segment prevalence within each demographic level: the design-weighted mean posterior in that subpopulation, with JKn intervals on the logit scale, the standard domain estimate. One demographic per page, table above plot, so nothing crowds.
